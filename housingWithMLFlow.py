...
housing_prepared,housing_labels,X_test_prepared,y_test=dataPrep(housing)
...
if __name__ == "__main__":
    ...
    housing_prepared,housing_labels,X_test_prepared,y_test=dataPrep(housing)
    train_x, train_y,test_x=housing_prepared,housing_labels,X_test_prepared
